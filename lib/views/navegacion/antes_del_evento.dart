...
class PreviaEvento extends StatefulWidget {
  const PreviaEvento({super.key, required this.idMaq, required this.op});
  final String idMaq;
  final String op;

  @override
  State<PreviaEvento> createState() => _PreviaEventoState();
}

class _PreviaEventoState extends State<PreviaEvento> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<OpProgramProvider>().obtenerOps(widget.op,widget.idMaq);
      // context.read<OpProgramProvider>().obtenerOps(widget.op, widget.idMaq);
    });
  }
        ...
        child: Row(
          ...
          children: [
            ...
            ElevatedButton(onPressed: (){
              ...
              context.read<OpProgramProvider>().obtenerOps( nuevaOp,widget.idMaq);
          ...
          Consumer<OpProgramProvider>(
            builder: (context, opProvider, child) {
              ...
              if (opProvider.listaOps.isEmpty) {
                return const SliverFillRemaining(
                  child:
                      Center(child: Text('No hay operaciones disponibles')),
                );
              }
                          ...
                          PageRouteBuilder(
                            pageBuilder:
                                (context, animation, secondaryAnimation) =>
                                     TiposEventos(motCodOdt: op.motCodOdt, secuencyMachine: op.secuencyMachine, motNroElem: op.motNroElem, odtMaq: op.motCodMaq, complement: op.motNroComplem, generado: '',),
                            transitionDuration:
                      ...
                      child: Card(
                        ...
                        shape: RoundedRectangleBorder(
                          ...
                          side: const BorderSide(
                              color: Color.fromARGB(255, 8, 35, 126),
                              width: 1),
                        ),
                        child: Padding(
                          padding: const EdgeInsets.symmetric(
                                  ...
                                  children: [
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        _infoRow('Sec: ', op.secuencyMachine),
                                      ],
                                    ),
...
class MySliverPersistent extends SliverPersistentHeaderDelegate {
  @override
  Widget build(
