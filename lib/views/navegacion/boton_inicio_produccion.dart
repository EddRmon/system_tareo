...
class _InicioProduccionState extends State<InicioProduccion> {
  ...
  Future<void> _loadState() async {
    try {
      ...
      final state = prefs.getBool('isProducing') ?? false; // Cargar el estado de Producción, valor predeterminado false
      setState(() {
        isProducing = state;
      });
    } catch (e) {
      print('Error al cargar el estado de Producción: $e');
  ...
  Future<void> _saveState() async {
    try {
      final prefs = await SharedPreferences.getInstance();
      await prefs.setBool('isProducing', isProducing);
    } catch (e) {
      print('Error al guardar el estado de Producción: $e');
    }
  }
        ...
        children: [
          ...
          Center(
            child: ElevatedButton(
                  ...
                  if (isProducing) {
                    ...
                    _showUnidadesProcesadasDialog(
                      ...
                      () {
                        ...
                        setState(() {
                          isProducing = false; // Volver a verde con "Iniciar"
                        });
              ...
              child: Text(
                isProducing ? 'Finalizar' : 'Iniciar ${widget.texto}',
